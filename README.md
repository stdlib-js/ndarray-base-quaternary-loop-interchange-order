...
```javascript
quaternaryLoopOrder = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-quaternary-loop-interchange-order@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/tags). For example,

```javascript
quaternaryLoopOrder = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-quaternary-loop-interchange-order@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var quaternaryLoopOrder = require( 'path/to/vendor/umd/ndarray-base-quaternary-loop-interchange-order/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-quaternary-loop-interchange-order@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/ndarray-base-quaternary-loop-interchange-order.svg
[npm-url]: https://npmjs.org/package/@stdlib/ndarray-base-quaternary-loop-interchange-order

[test-image]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/ndarray-base-quaternary-loop-interchange-order/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/ndarray-base-quaternary-loop-interchange-order?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-base-quaternary-loop-interchange-order.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-base-quaternary-loop-interchange-order/main
...
[deno-url]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/tree/deno
[deno-readme]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/ndarray-base-quaternary-loop-interchange-order/main/LICENSE
